      ...
      <div class="skill-list other-skills">
        <div class="skill-list__item">
          ...
          <div class="skill-list__item__info">
            ...
            <p class="skill-list__item__info__text">2DCAD<br>経験年数13年以上<br>2D操作は一通り可能<br>※CADは所持しておりません</p>
          </div>
        </div>
        ...
        <div class="skill-list__item">
          ...
          <div class="skill-list__item__info">
            ...
            <p class="skill-list__item__info__text">3DCAD<br>モデリング、解析など可能<br>※CADは所持しておりません</p>
          </div>
        </div>
        ...
        <div class="skill-list__item">
          ...
          <div class="skill-list__item__info">
            ...
            <p class="skill-list__item__info__text">3DCAD<br>モデリング、2D図面作成など可能<br>※CADは所持しておりません</p>
          </div>
        </div>
      </div>
    </div>
